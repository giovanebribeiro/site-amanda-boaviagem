...
const DataStore: DataStoreType = {
  items: [
    {
      id: 1,
      slug: "amor-nos-tempos-de-quarentena",
      ...
      slogan: "Uma história de amor e resiliência nos tempos da pandemia.",
      reviews: [
        {
          author: "Leitora Placeholder A",
          text: "Uma leitura emocionante que me prendeu do início ao fim. Recomendo muito!",
        },
        {
          author: "Leitora Placeholder B",
          text: "Amanda consegue capturar com sensibilidade a angústia e a esperança desse período.",
        },
      ],
    },
    {
      id: 2,
      slug: "contronicas-historias-amorfas-de-quarentena",
      title:
      ...
      slogan: "Histórias reais de pessoas reais em tempos extraordinários.",
      reviews: [
        {
          author: "Leitora Placeholder C",
          text: "Uma coletânea poderosa que retrata a humanidade em sua forma mais verdadeira.",
        },
        {
          author: "Leitora Placeholder D",
          text: "Cada conto me fez refletir sobre o que realmente importa na vida.",
        },
      ],
    },
    {
      id: 3,
      slug: "contronicas-historias-amorfas-de-quarentena-2a-ed",
      title:
      ...
      slogan: "A segunda edição ampliada de uma obra que tocou corações.",
      reviews: [
        {
          author: "Leitora Placeholder E",
          text: "A segunda edição trouxe ainda mais riqueza a uma obra já especial.",
        },
        {
          author: "Leitora Placeholder F",
          text: "Uma leitura necessária para entender o que vivemos juntos.",
        },
      ],
    },
    {
      ...
      reviews: [
        {
          author: "Leitora Placeholder G",
          text: "Reli na segunda edição e me emocionei ainda mais. Uma obra atemporal.",
        },
        {
          author: "Leitora Placeholder H",
          text: "Amanda Boaviagem escreveu algo que vai ficar comigo para sempre.",
        },
      ],
    },
  ],
